...
public class Dashboard extends JFrame{
    ...
    public Dashboard() {
        ...
        JLabel HotelManagment = new JLabel("THE TAJ GROUP WELCOMES YOU");
        HotelManagment.setForeground(Color.WHITE);
        HotelManagment.setFont(new Font("Tahoma", Font.PLAIN, 46));
        HotelManagment.setBounds(350, 60, 1000, 85);
        NewLabel.add(HotelManagment);
